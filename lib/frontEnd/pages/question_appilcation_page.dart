...
class MyCustomFormState extends State<MyCustomForm> {
              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    padding: const EdgeInsets.only(top: 5, bottom: 2.5, left: 10, right: 10),
                    margin: const EdgeInsets.only(top: 15, bottom: 0, left: 20, right: 20),
                    child: const Text(
                      '題目標題', style: TextStyle(fontSize: 20,fontWeight: FontWeight.normal),
                  ...
                  Container(
                    ...
                    padding: const EdgeInsets.only(top: 2.5, bottom: 5, left: 10, right: 10),
                    margin: const EdgeInsets.only(top: 0, bottom: 15, left: 20, right: 20),
                    child: const Text(
                      '題目描述', 
                      style: TextStyle(color: Colors.grey, fontSize: 20, height: 2.0),
                      textAlign: TextAlign.start
                    )
                  )
                ],
              ...
              Column(
                ...
                children: [
                  Container(
                    ...
                    margin: const EdgeInsets.only(top: 15, bottom: 0, left: 20, right: 20),
                    child: const Text(
                      '需求', style: TextStyle(fontSize: 20,fontWeight: FontWeight.normal),
                      textAlign: TextAlign.start,
                    )
                  ),
                  Container(
            ...
            Container(
              ...
              child: ElevatedButton(
                style: ButtonStyle(
                  ...
                  backgroundColor: MaterialStateProperty.all<Color>(const Color.fromARGB(198, 192, 220, 236)),
                  foregroundColor: MaterialStateProperty.all<Color>(Colors.black),
                ),
                onPressed: () {
                ...
                child: const Text("應徵", style: TextStyle(fontSize: 20, fontWeight: FontWeight.normal),),
              ),
            ),
          ],
        ),
  ...
  Future<DateTime?> pickDate() => showDatePicker(
    ...
    lastDate: DateTime(currentTime.year, currentTime.month, currentTime.day + 7),
  );
}