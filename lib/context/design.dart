...
class Design {
  ...
  static const outsideSpacing = EdgeInsets.only(
            top: Design.outsideUpSpacing,
            left: Design.outsideLeftSpacing,
            right: Design.outsideRightSpacing,
            bottom: Design.outsideDownSpacing);

  static const insideSpacing = EdgeInsets.all(10.0);

  static const outsideUpSpacing = 40.0;
  static const outsideDownSpacing = 20.0;
  static const outsideLeftSpacing = 20.0;
  static const outsideRightSpacing = 20.0;
  static const outsideBorderRadius = 20.0;
  static const insideBorderRadius = 40.0;
}